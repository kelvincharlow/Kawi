  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-green-50 via-emerald-50 to-teal-50 rounded-xl p-6 border border-green-200 shadow-lg">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="text-2xl font-bold text-gray-800 mb-1">Driver Management</h2>
              <p className="text-gray-600">Manage driver profiles, licenses, and vehicle assignments</p>
              <div className="flex items-center gap-4 mt-2 text-sm">
                ...
                <span className="flex items-center gap-1 text-orange-600">
                  <Car className="h-4 w-4" />
                  {assignments.filter(a => a.status === 'active').length} current assignments
                </span>
              </div>
            </div>
          </div>
          <div className="flex gap-3">
            <Dialog open={isAssignDialogOpen} onOpenChange={setIsAssignDialogOpen}>
              <DialogTrigger asChild>
                <Button variant="outline" className="bg-blue-50 hover:bg-blue-100 border-blue-200 text-blue-700 flex items-center gap-2">
                  <Car className="h-4 w-4" />
                  Assign Vehicle
                </Button>
              </DialogTrigger>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        <TabsList className="grid w-full grid-cols-2 bg-gradient-to-r from-gray-50 to-green-50 rounded-xl p-1 shadow-sm border border-gray-200">
          <TabsTrigger 
            value="drivers"
            className="data-[state=active]:bg-white data-[state=active]:shadow-md data-[state=active]:text-green-600 rounded-lg font-medium"
          >
            Drivers 
          ...
          <TabsTrigger 
            value="assignments"
            className="data-[state=active]:bg-white data-[state=active]:shadow-md data-[state=active]:text-blue-600 rounded-lg font-medium"
          >
            Vehicle Assignments
